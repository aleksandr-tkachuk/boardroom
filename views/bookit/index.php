...
<form action="index.php?c=bookit&a=index&room=<?= $form["room"] ?>" method="post">
    ...
    <p>If weekly,or bi-weekly,specify the number of weeks for it to keep recurring.</p> If monthly, specify,
    the number of months.(If you choose "bi-weekly" and put in an add number of weeks, the computer will round
    down.)<br>
    <input type="number" name="duration" value="<?= $form["duration"] ?>" max="4" min="0"><label>duration(max 4 weeks)</label><br>
    <br><br>
